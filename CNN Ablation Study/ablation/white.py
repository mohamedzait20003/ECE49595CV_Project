# Fine-tune ResNet-50 on a "white-background" variant of Stanford Cars.
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Fine-tune ResNet-50 on a white-background Cars variant (baseline aug)."
    )
    p.add_argument("--data-root", type=Path, default=Path("/home/jut/white_clean"))
    ...
    p.add_argument("--ckpt-dir", type=Path, default=Path("checkpoints_white"))
